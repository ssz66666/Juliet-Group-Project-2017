...
public class TestPhysicsHingeJoint extends SimpleApplication implements AnalogListener {
    ...
    private void setupKeys() {
        ...
        inputManager.addMapping("Swing", new KeyTrigger(KeyInput.KEY_J), new KeyTrigger(KeyInput.KEY_SPACE));
    ...
    public void setupJoint() {
        ...
        joint=new HingeJoint(holderNode.getControl(RigidBodyControl.class), hammerNode.getControl(RigidBodyControl.class), Vector3f.ZERO, new Vector3f(0f,-2,0f), Vector3f.UNIT_Z, Vector3f.UNIT_Z);
